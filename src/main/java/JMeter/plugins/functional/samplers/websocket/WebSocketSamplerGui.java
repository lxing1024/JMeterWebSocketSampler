...
public class WebSocketSamplerGui extends AbstractSamplerGui {
    ...
    public void configure(TestElement element) {
        ...
        if (element instanceof WebSocketSampler) {
            ...
            webSocketSamplerPanel.setRequestType(webSocketSamplerTestElement.getRequestType());
    ...
    public void modifyTestElement(TestElement te) {
        ...
        if (te instanceof WebSocketSampler) {
            ...
            webSocketSamplerTestElement.setRequestType(webSocketSamplerPanel.getRequestType());
